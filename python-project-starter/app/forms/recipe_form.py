...
class RecipeForm(FlaskForm):
    ...
    ingredients = FieldList(StringField("ingredients", validators=[DataRequired()]), min_entries=1)
    directions = FieldList(StringField("directions", validators=[DataRequired()]), min_entries=1)
